...
from app.presentation.common.interfaces.gateway_factory import GatewayFactory
from app.presentation.telegram.common.interfaces.handler_factory import H, HandlerFactory

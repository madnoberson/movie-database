...
from app.application.interactors.registration.register.dto import RegisterDTO
from app.application.interactors.registration.register.interactor import Register
from app.application.queries.user.check_username_exists.dto import CheckUsernameExistsDTO
from app.application.queries.user.check_username_exists.handler import CheckUsernameExists
from app.presentation.telegram.common.interfaces.handler_factory import HandlerFactory
from app.presentation.telegram.common.interfaces.session_manager import SessionManager
from . import states

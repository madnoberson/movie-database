...
class Person(BaseModel):
    ...
    career: Sequence[PersonCareer] | None
    ...
    def create(
        ...
        last_name: str, career: PersonCareer | None = [],
        genres: Sequence[MovieGenreEnum] | None = [],
    ...
    def update(
        self, updated_at: datetime, first_name: str | None = None, last_name: str | None = None,
        movie_count: int | None = None, career: Sequence[PersonCareer] | None = None,
        genres: Sequence[MovieGenreEnum] | None = None, avatar_url: str | None = None,
        birth_date: date | None = None, birth_place: str | None = None,
        death_date: date | None = None, death_place: str | None = None,
        kinopoisk_id: str | None = None, imdb_id: str | None = None
    ) -> None:
        updated_fields = self.update_fields(
            first_name=first_name, last_name=last_name, movie_count=movie_count,
            career=career, genres=genres, avatar_url=avatar_url, birth_date=birth_date,
            birth_place=birth_place, death_date=death_date, death_place=death_place,
            kinopoisk_id=kinopoisk_id, imdb_id=imdb_id
        )
        if updated_fields: self.updated_at = updated_at
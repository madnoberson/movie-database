...
class IoC(HandlerFactory):
    ...
    def __init__(self, factory_manager: AsyncpgFactoryManager) -> None:
        self.factory_manager = factory_manager

    @asynccontextmanager
    async def register(self) -> AsyncIterator[Register]:
        async with self.factory_manager.build_repository_factory() as factory:
            yield Register(
    ...
    async def login(self) -> AsyncIterator[Login]:
        async with self.factory_manager.build_reader_factory() as factory:
